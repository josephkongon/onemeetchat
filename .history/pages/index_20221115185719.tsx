        ...
        >
          ...
          >
            <Box fontSize='1.5rem' p={{ base: '1rem', md: 'unset' }}>
              <Text>
                one meet chat is a random Video call and messaging site, where
                you can talk with strangers all around the world
              </Text>
            </Box>
          </Box>
          <Box
            ...
            >
              ...
              <Box w='100%' ml={{ base: '0', md: '3rem' }}>
                ...
                <Text
                  ...
                  ml={{ base: '0', md: '2rem' }}
                >
                  With one meet chat , you can talk to stranger on video calls
                  as well as on message. the messages as also been intergrated
                  to the call so that you can send messages to someone even on
          ...
          >
            <Box w={{ base: '100%', md: '50%' }}>
              ...
              <Text fontSize={'1.3rem'} pl='2rem'>
                ...
                need to do is to select your gender. now depence on what you
                want, you can go for calls or messages
              </Text>
            </Box>
            <Box>
              <Image
          ...
          >
            ...
            >
              ...
              <Text fontSize={'1.3rem'} w='70%'>
                one meet chat is build with user experience in mind. here you
                get a responsive site but on computer and on your smart phone.
                which makes it easy to use on mobile devices
              </Text>
            </Box>
          </Box>
        </Box>
